      ...
      <div className="relative w-full min-w-0 overflow-hidden">
        ...
        {canScrollLeft && (
          <button
            ...
            className="absolute left-2 top-[220px] z-30 w-8 h-8 rounded-full bg-oa-white/95 border border-oa-stone-200 shadow-md flex items-center justify-center text-oa-black-700 hover:bg-oa-sand-100 transition-colors"
